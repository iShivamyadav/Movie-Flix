        ...
        <div class="row">
            <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
                <div class="card card-signin my-5">
                    <div class="card-body">
                        <div class="wrapper">
                            <h2 class="text-center">MOVIE FLIX LOGIN</h2>
                            <br>
                            <h5><p class="text-center">Please fill in your credentials to login.</p></h5>
                            <hr>
                            <form action="<?= htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <p>Don't have an account? <a href="myform.php">Sign up now</a>.</p>
                            </form>
                        </div>    
                    </div>
                </div>
